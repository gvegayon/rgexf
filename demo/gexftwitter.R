...
relations2 <- relations #[1:2000,]
system.time(x1 <- write.gexf(nodos,relations2, keepFactors=F, nodesAtt=nodos.att))
system.time(x2 <- write.gexf2(nodos,relations2, keepFactors=F, nodesAtt=nodos.att))